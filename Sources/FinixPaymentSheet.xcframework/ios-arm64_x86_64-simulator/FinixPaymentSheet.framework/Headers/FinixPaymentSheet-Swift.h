...
- (nonnull instancetype)initWithTitle:(NSString * _Nullable)title branding:(Branding * _Nonnull)branding buttonTitle:(NSString * _Nonnull)buttonTitle enableCardScanning:(BOOL)enableCardScanning OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly, copy) NSString * _Nullable title;
...
@property (nonatomic, readonly) BOOL enableCardScanning;
